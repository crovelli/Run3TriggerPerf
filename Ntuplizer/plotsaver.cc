...
void plotsaver(){
    ...
    TFile *f = TFile::Open("/eos/user/j/jodedra/Run3/NoTrigMatch/testuproot.root");
    TTree *events = (TTree*)f->Get("tree");
    TCanvas *c1 = new TCanvas("c1"); 
    TH1D *myh = new TH1D("myh"," B_mass plot 2022 data HLTPhysics",40,4.6,6.0);
    myh->SetOption("E");
    ...
    c1->SaveAs("BMASS5GBsdadasfas.png");  
    c1->SaveAs("BMASS5GBweqweq.pdf");   
