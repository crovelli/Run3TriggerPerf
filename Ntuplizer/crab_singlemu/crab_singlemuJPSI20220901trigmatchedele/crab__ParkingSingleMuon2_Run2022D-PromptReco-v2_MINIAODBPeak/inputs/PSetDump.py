...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2022C/ParkingSingleMuon0/MINIAOD/PromptReco-v1/000/356/722/00000/c29329d0-0fc7-467b-9a81-7cc8b0a3c18a.root')
)
...
process.nano = cms.EDAnalyzer("NanoAnalyzerSingleMu",
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('ParkingsingleMuon20220824withtrigmatchingnumerator.root')
)
