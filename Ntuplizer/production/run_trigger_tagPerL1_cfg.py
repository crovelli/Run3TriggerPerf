...
options.register('whichTrigger','L1',
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
...
outputFileTrigger = cms.string('TriggerTagPerL1.root')
...
process = cms.Process('NanoAnalyzerDoubleMuTagPerL1')
...
# Analyzer
process.nano_ = cms.EDAnalyzer('NanoAnalyzerDoubleMu_tagPerL1',
