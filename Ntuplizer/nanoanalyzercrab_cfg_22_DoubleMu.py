...
inputFiles= [
    '/store/data/Run2022C/ParkingDoubleMuonLowMass0/MINIAOD/PromptReco-v1/000/355/999/00000/1d7a02c9-5bae-4e5c-8935-584f29d8e4ef.root',
...
process.TFileService = cms.Service("TFileService",
                                    fileName = cms.string ('DoubleMuonEEKLowMassJpsimassincrease20220811.root')
                                   )


# Process the analyzer
process.nano = cms.EDAnalyzer('NanoAnalyzerDoubleMu',
